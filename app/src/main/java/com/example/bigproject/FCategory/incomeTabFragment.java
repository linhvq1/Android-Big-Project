...
public class incomeTabFragment extends Fragment {
        ...
        private View mViewIncome;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        mViewIncome =  inflater.inflate(R.layout.fragment_income_tab, container, false);
        assetManager = getActivity().getAssets();
        recyclerView = mViewIncome.findViewById(R.id.rcv_income_cat);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(incomeTabFragment.this.getContext());
    ...
    public void loaddata(){
        list = DatabasePro.getInstance(this.getContext()).catDAO().getListInCategory();
        adapter.setData(list,assetManager);
    }
        ...
        AlertDialog dia = new AlertDialog.Builder(this.getContext())
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        DatabasePro.getInstance(incomeTabFragment.this.getContext()).catDAO().deleteCat(cat);
                        Toast.makeText(incomeTabFragment.this.getContext(),"Delete Successfully",Toast.LENGTH_SHORT).show();
                        loaddata();
                    }
                })
    ...
    private void CliclupdateCat(Table_Category cat) {
        Intent i = new Intent(incomeTabFragment.this.getActivity(),Edit_Category.class);
